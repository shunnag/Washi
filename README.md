...
`https://github.com/shunnag/Washi.git` を入力し、**Up to Next Major Version: 1.21.0**
...
enter `https://github.com/shunnag/Washi.git`, and use **Up to Next Major Version: 1.21.0**.
