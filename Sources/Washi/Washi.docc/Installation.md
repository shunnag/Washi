...
macOS 14 以降、Swift 6 を使う。ガイドとサンプルは Washi 1.19.0 の公開 API に対応する。
Washi は AppKit/WebKit を使う表示層、WashiCore は UI を使わない解析層。
両方とも第三者パッケージへの依存はない。

Use macOS 14+ and Swift 6. These guides and samples use the public API in Washi 1.19.0.
...
2. **Up to Next Major Version: 1.19.0** を選ぶ。
...
**Up to Next Major Version: 1.19.0**. Add **Washi** to the app target for rendering,
